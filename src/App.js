...
class App extends React.Component{
  ...
  constructor(props) {
    super(props);
    this.state = {
      fullName: "Aziz Zarrad",
      bio: "Professor Zarrad is an astroparticle physicist from tunisia, interested in understanding the origin of Dark Matter. She uses a combination of simulations and observational data to correlate the dynamics of Dark Matter with that of the stars in the Milky Way, and infer properties of Dark Matter.",
      imgSrc: myImage,
      ...
      <div className="App">
        {this.state.bool ? (
          <div>
            ...
            <h2 style={{ color: "#0DB8EF" }}>Aziz Zarrad bio</h2>
